...
public class SQLManager extends DatabaseManager{
	...
	public HashMap<String,String> selectUser(String id, String time) throws SQLException, ClassNotFoundException, ParseException{
		...
		sql +="WHERE pharmacy_id = '"+id+"' AND reservation_time = '2016-03-09 "+time+":00:00' AND state_flg = 0 ";
...
//				System.out.println(datetime);
	 ...
	 * @throws ParseException
	 */
	public HashMap<String,String> AndoroidTimeList(String id, String time) throws SQLException, ClassNotFoundException, ParseException{
		HashMap<String,String> map = new HashMap<String,String>();
		...
		try {
			if(rs.next()){
				...
				Date datetime = sdf.parse(rs.getString("reservation_time"));
//				System.out.println(datetime);
				map.put("reservation_time", time+":00");
				map.put("counttime", rs.getString("counttime"));
				intRec = 1;
			}
		} catch (SQLException e) {
