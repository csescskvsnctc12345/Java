...
/**
 * Servlet implementation class AndroidConnectServlet
 */
@WebServlet("/AndroidConnectServlet")
public class AndroidConnectServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public AndroidConnectServlet() {
        super();
