...
public class QRActivity extends Activity  {
	...
	private static final String ACCESS_URL = "http://172.20.10.2:8080/hal_work2/AndroidInsertServlet";
	...
	protected void onActivityResult(int request, int result, Intent intent) {
		...
		case REQUEST_SCAN:
			if(result == Activity.RESULT_OK) {
				...
				Builder builder = new Builder(QRActivity.this);
				builder.setTitle("予約確認");
				builder.setMessage("薬局名：" + store_name + "\n" + "予約時間：" + date+" "+time);
				...
				builder.setPositiveButton("予約する", new OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						access.execute(ACCESS_URL+"?store_id="+store_id+"&datetime="+time+"&QRcode="+resultStr);//非同期通信を開始引数としてURLを渡す
					}
				});
				builder.create().show();
	...
	private class RestAccess extends AsyncTask<String, Void, String>{
		...
		protected void onPostExecute(String result){
			Builder builder = new Builder(QRActivity.this);
			builder.setTitle("予約完了");
			builder.setMessage("予約完了しました。");
			builder.setPositiveButton("OK", new OnClickListener() {
				...
				public void onClick(DialogInterface dialog, int which) {
					...
					Intent intent = new Intent(QRActivity.this,AddressPrefecturesActivity.class);
