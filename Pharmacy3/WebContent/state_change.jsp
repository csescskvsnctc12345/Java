...
String strjson = reservation.getStateJSON(store_id);
...
<div id="wrapper">
	<div id="header">
		...
		<h2>
			<font color="00ff00">処方完了画面</font>
		</h2>
	</div>
	<div class="nav">
		<ul class="nl clearFix">
			<li><a href="index.jsp">予約一覧 <span class="en">Reservation</span></a></li>
			<li id="select"><a href="state_change.jsp">処方完了一覧 <span class="en">Completion</span></a></li>
...
<div id="dialog" title="詳細画面">
	...
	<!-- 受取完了させる為にServletにバーコードの値を送る -->
	<form method="get" action="./StateServlet" id="process_form">
...
<%}%>
	jQuery(document).ready(function(){
		...
		jQuery("#list").jqGrid({
			data: mydata,
			datatype: "local",
			colNames:['ID', '患者名', '予約時間','予約された薬の処方','受け取り','電話番号'],
			//列の設定
			colModel : [ {
				index : 'barcode_id',
				name : 'barcode_id',
			...
			multiselect: false,
			caption: '予約一覧',
			sortname : "barcode_id", //デフォルトでcodeをみてソートし表示する
			sortorder : "ASC",
			rowNum : 30, // 1ページの表示件数
